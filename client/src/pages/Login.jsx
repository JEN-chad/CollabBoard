      ...
      >
        ...
        <div className="mb-6 text-center md:text-left">
          ...
          <p className="text-sm text-textSecondary mt-1.5">
            Log in to access your collaborative boards
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between text-xs pt-1 select-none">
            <label className="flex items-center gap-2 font-medium text-textSecondary hover:text-textPrimary cursor-pointer min-h-[32px]">
              <input
                type="checkbox"
                name="rememberMe"
                checked={formData.rememberMe}
                onChange={handleChange}
                className="h-4 w-4 rounded border-border bg-[#090d16] text-primary focus:ring-primary/30 focus:ring-offset-0 focus:outline-none"
              />
            ...
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                alert('Password reset functionality is not implemented in this MVP.');
              }}
        ...
        <Button
          variant="outline"
          fullWidth
          onClick={() => alert('Social authentication is UI-only for this MVP.')}
          className="flex items-center justify-center gap-2 hover:bg-[#1e293b]/40"
        >
